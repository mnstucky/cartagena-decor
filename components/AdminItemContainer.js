...
function AdminItemContainer({ selection, setSelection, item, itemUrl }) {
  ...
  async function uploadImage(event) {
    ...
    const convertedImageUrl = `${itemUrl}_${convertedSelection
      .replaceAll(" ", "")
      .toLowerCase()}.JPG`;
  ...
  for (const [key, value] of Object.entries(item.multiples.options)) {
    ...
    const formattedOption =
      keyWithSpacesAdded.charAt(0).toUpperCase() + keyWithSpacesAdded.slice(1);
      ...
      <div className="columns">
        <div className="column">
          ...
          <section className="box content">
            ...
            <p>
              (Image must be in .JPG format. Preferred dimensions are 720 x
              480.)
            </p>
            ...
            {!(item.multiples.hasMultiples && selection === "default") && (
              <>
                <div className="is-flex is-align-items-center">
                  ...
                  <p className="ml-3 mr-3 mb-0">{stock}</p>
        ...
        <div className="column">
          <section className="box content">
            <form onSubmit={handleSubmit}>
              ...
              />
              <ControlledTextareaList
                fieldName="Description"
                fields={description}
                setFields={setDescription}
              />
              <ControlledTextareaList
                fieldName="Feature"
                fields={features}
                setFields={setFeatures}
              />
              <ControlledTextareaSingle
                fieldName="Highlights"
                field={highlights}
                setField={setHighlights}
              />
              <div className="is-flex is-align-items-center">
                <input
